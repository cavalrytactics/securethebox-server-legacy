...
spec:
  ...
  - host: auth.securethebox.us
    ...
    with open('./app_controllers/infrastructure/kubernetes-deployments/authentication/'+str(sys.argv[2])+'/03_'+str(sys.argv[1])+'-'+str(sys.argv[2])+'-'+str(sys.argv[3])+'-ingress.yml', 'w') as yfile:
